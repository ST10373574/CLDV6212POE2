...
namespace ABCRetailApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> StoreCustomer(CustomerProfile customer)
        {
            ...
            var response = await _httpClient.PostAsync("https://st10373574.azurewebsites.net/api/StoreCustomerProfile?code=M1CA43t_6HlYgB9NrHXwA6toRClwzjp_dpRL-NluRFJFAzFu5AV3sw%3D%3D", content);
