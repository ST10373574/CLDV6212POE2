    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product, IFormFile imageFile)
        {
            ...
            try
            {
                ...
                var response = await httpClient.PostAsync("https://st10373574.azurewebsites.net/api/StoreProduct?code=M1CA43t_6HlYgB9NrHXwA6toRClwzjp_dpRL-NluRFJFAzFu5AV3sw%3D%3D", httpContent);
