        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var response = await _httpClient.PostAsync("https://st10373574.azurewebsites.net/api/orders/process?code=M1CA43t_6HlYgB9NrHXwA6toRClwzjp_dpRL-NluRFJFAzFu5AV3sw%3D%3D", content);
